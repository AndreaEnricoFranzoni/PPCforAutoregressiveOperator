...
//how many PPCs have to be retained: generalizaed method
template< class D, DOM_DIM dom_dim, K_IMP k_imp, VALID_ERR_RET valid_err_ret, CV_STRAT cv_strat, CV_ERR_EVAL cv_err_eval >
std::tuple<int,KO_Traits::StoringVector,KO_Traits::StoringMatrix>
PPC_KO_base<D, dom_dim, k_imp, valid_err_ret, cv_strat, cv_err_eval>::PPC_retained(double tot_exp_pow)
const
{
...
{ 
  ...
  std::tuple<int,KO_Traits::StoringVector,KO_Traits::StoringMatrix> ppcs_ret;
