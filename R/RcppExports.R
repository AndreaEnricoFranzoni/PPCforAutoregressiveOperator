...
PPC_KO <- function(X, id_CV = "NoCV", alpha = 0.75, k = 0L, threshold_ppc = 0.95, alpha_vec = NULL, k_vec = NULL, toll = 1e-4, disc_ev = NULL, left_extreme = 0, right_extreme = 1, dom_dim_s = 1L, err_ret = 0L, id_rem_nan = NULL) {
